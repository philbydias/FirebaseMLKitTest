...
class FirebasePhotoService: PhotoProcessingProvider {
    ...
    private var currentTask: Task<FirebaseVisionText>? = null
    ...
    override fun translateToText(fromBitmap: Bitmap) {
        ...
        currentTask = detector.processImage(fbVisionImage).addOnSuccessListener { firebaseVisionText: FirebaseVisionText? ->
